...
import adminReelsRouter from './admin-reels';
...
import adminDigestRouter from './admin-digest';
...
router.use('/admin/reels', adminReelsRouter);
...
router.use('/admin/digest', adminDigestRouter);
