...
// In production, opt-in only (AUTO_*=true). In dev, opt-out (AUTO_*=false).
// This prevents accidental schema/seed runs on multi-instance prod deploys.
const AUTO_MIGRATE = isProd
  ? process.env.AUTO_MIGRATE === 'true'
  : process.env.AUTO_MIGRATE !== 'false';
const AUTO_SEED = isProd
