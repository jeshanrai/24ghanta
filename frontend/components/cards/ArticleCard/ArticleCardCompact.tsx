  ...
  return (
    <article className="py-3 border-b border-[var(--color-border-light)] last:border-b-0">
      <Link href={`/article/${article.slug}`} className="group block">
        <h3 className="font-headline text-sidebar-title text-[var(--color-text-primary)] group-hover:text-[var(--color-primary)] transition-colors duration-200 line-clamp-2">
          {article.title}
        </h3>
