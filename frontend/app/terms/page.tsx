    ...
    <div className="container py-8 sm:py-10 lg:py-14 animate-fade-in-up">
      <div className="max-w-3xl mx-auto">
        ...
        <section className="space-y-6 text-[13px] sm:text-[14px] text-[var(--color-text-secondary)] leading-relaxed">
          <div>
            <h2 className="text-[16px]! sm:text-[18px]! font-bold text-[var(--color-text-primary)] mb-2">1. Acceptance</h2>
            <p>
          ...
          <div>
            <h2 className="text-[16px]! sm:text-[18px]! font-bold text-[var(--color-text-primary)] mb-2">2. Content Ownership</h2>
            <p>
          ...
          <div>
            <h2 className="text-[16px]! sm:text-[18px]! font-bold text-[var(--color-text-primary)] mb-2">3. User Conduct</h2>
            <p>
          ...
          <div>
            <h2 className="text-[16px]! sm:text-[18px]! font-bold text-[var(--color-text-primary)] mb-2">4. Disclaimer</h2>
            <p>
          ...
          <div>
            <h2 className="text-[16px]! sm:text-[18px]! font-bold text-[var(--color-text-primary)] mb-2">5. Changes</h2>
            <p>
