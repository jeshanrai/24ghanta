...
import { LogOut, LayoutDashboard, FileText, Settings, ExternalLink, Menu, BarChart3, Video, Tag, UserPen, Mail, Vote, TrendingUp, Megaphone } from "lucide-react";
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const adminOnlyPrefixes = ["/admin/categories", "/admin/tags", "/admin/authors", "/admin/subscribers", "/admin/polls", "/admin/trending", "/admin/ads", "/admin/settings"];
